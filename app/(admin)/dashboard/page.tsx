      ...
      <div className="space-y-6">
        ...
        <div className="bg-gradient-to-r from-blue-600 to-blue-700 rounded-lg shadow-lg p-6 text-white">
          ...
          <p className="text-blue-100">
            Kelola sistem Anda dengan mudah melalui dashboard admin ini.
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
          {/* Recent Activity */}
          <Card title="Aktivitas Terbaru" subtitle="Aktivitas sistem dalam 24 jam terakhir">
            <div className="space-y-4">
              ...
              <div className="flex items-center space-x-3">
                ...
                <div className="flex-1">
                  <p className="text-sm font-medium text-gray-900">Order baru diterima</p>
              ...
              <div className="flex items-center space-x-3">
                ...
                <div className="flex-1">
                  <p className="text-sm font-medium text-gray-900">Pembayaran pending</p>
          ...
          {/* Quick Actions */}
          <Card title="Quick Actions" subtitle="Aksi cepat untuk tugas sehari-hari">
            <div className="grid grid-cols-2 gap-4">
              ...
              <button className="p-4 border border-gray-200 rounded-lg hover:bg-gray-50 transition-colors duration-200">
                <div className="flex flex-col items-center space-y-2">
                  ...
                  <span className="text-sm font-medium text-gray-900">Buat Report</span>
                </div>
              </button>
        ...
        {/* System Status */}
        <Card title="System Status" subtitle="Status kesehatan sistem saat ini">
